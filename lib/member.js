...
module.exports = {
    ...
    create_process : (req, res)=>{
        ...
        var sntzedPhoneNumber = sanitizeHtml(post.phoneNumber);

        //로그인 되어있을 경우에만 db 접속
        if(login===true){
            
            //db insert query
            db.query(`INSERT INTO member (nickName, password, birth, phoneNumber) VALUES (?, ?, ?, ?)`,
                [sntzedNickName, sntzedPassword, sntzedBirth, sntzedPhoneNumber], (error, results)=>{
